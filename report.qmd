...
Table with all markers found within each Time + Area. So for example, it will find markers
...
markers %>% select(Gene = gene, Cluster = cluster,
                   Area = area, Age = age, avg_log2FC, pct.1, pct.2, p_val_adj) %>%
datatable(
  markers,rownames = F,
  extensions = 'Buttons',
  options = list(
